...
export interface ComponentManifest {
  ...
  /**
   * Type of component that will be deployed to different runtimes
   */
  type?: 'edge' | 'server';
  /**
...
export interface ComponentFunction {
  ...
  queryParameters?: {
    [k: string]: QueryParameterValueType;
  };
  [k: string]: unknown;
}
...
export interface QueryParameterValueType {
  required: boolean;
  [k: string]: unknown;
}
/**
...
export interface MatrixAssetSchema {
  ...
  /**
   * Lineages which the asset is accessible from.
   */
  lineages?: AssetLineage[];
  /**
   * The child count for the asset.
   */
  child_count?: number;
  [k: string]: unknown;
}
...
export interface AssetLineage {
  /**
   * Path to the asset, starting from the root node "1" down to the leaf asset node. Ordered by depth.
   */
  asset_ids: string[];
  /**
   * Will be true if one of the "asset_ids" is a system asset.
   */
  inside_system_asset: boolean;
  [k: string]: unknown;
}
